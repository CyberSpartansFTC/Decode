...
@Autonomous(name = "Decode Auto Red")
public class DecodeAutoRed extends NextFTCOpMode {
    ...
    public void onStartButtonPressed() {
        PedroPathingAutoRed.INSTANCE.setPathState(PedroPathingAutoRed.PathState.PICKUP1);
    }
    @Override
